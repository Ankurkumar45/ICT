...
<body>
	...
	<?php
	require 'configure.php';
	$qurey = mysqli_query($db, "SELECT * FROM women_with_grade_ab");
	while ($view = mysqli_fetch_array($qurey)) {
		echo "
			<div class='container'>
            <img src='{$view['Image']}'><br><span id='Name'>{$view['Name']}</span><br><span id='Role'>{$view['Role']}</span>
	...
	<?php
	require 'configure.php';
	$qurey = mysqli_query($db, "SELECT * FROM women_with_grade_ac");
	while ($view = mysqli_fetch_array($qurey)) {
		echo "
			<div class='container'>
            <img src='{$view['Image']}'><br><span id='Name'>{$view['Name']}</span><br><span id='Role'>{$view['Role']}</span>
